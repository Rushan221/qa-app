                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="ml-auto">
                                <a href="{{route('questions.index')}}"
                                   class="btn btn-outline-secondary">{{__('Back to all questions')}}</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <form action="{{route('questions.store')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control {{$errors->has('title') ? 'is-invalid':''}}" name="title"
                                       placeholder="Enter question title" type="text" value="{{old('title')}}">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                <button type="submit"
                                        class="btn btn-outline-primary btn-lg">{{__('Ask this question')}}</button>
                            </div>
                        </form>
                    </div>
                </div>
